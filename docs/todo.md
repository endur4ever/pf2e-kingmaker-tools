Done camping zones need to have the zone name on it
Done next section after eating set watches, drag and drop
Done setup camping activities 
Done Get a list of activities 
     each activity takes 2 hours, no 2 pc may attempt the same camping activity at the same time. once its at least a success that activyt caanot be attempted again. There are 8 hours of downtime max. 
Done expand on the eating part past the rations. There are meals they can make get the list of them.
DONE grab the learning from companions chart, to see if camp activity is available. Probably have it part of the list of camp activities but greyed out if that certain NPC is not in the camp.
Done add camp Precipitation Check, Tempature, Weather events rolls, with tool tip
    precipitation DC 20 summer, DC 15 for spring and fall, DC 8 during winter. 
