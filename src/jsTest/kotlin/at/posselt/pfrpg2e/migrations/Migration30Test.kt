...
class Migration30Test {
    ...
    @Test
    fun testMigration30SeedsAllSixFields() = runTest {
        val gameMock = unsafeJso<Game>()
        val kingdom = unsafeJso<dynamic> {}

        Migration30().migrateKingdom(gameMock, kingdom)
    ...
    @Test
    fun testMigration30PreservesExistingFields() = runTest {
        val gameMock = unsafeJso<Game>()
        val kingdom = unsafeJso<dynamic> {
    ...
    @Test
    fun testMigration30HandlesPartialExistingFields() = runTest {
        val gameMock = unsafeJso<Game>()
        val kingdom = unsafeJso<dynamic> {
            questTemplates = arrayOf("existing")
